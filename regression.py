...
############################################ FINAL DATASET ################################
df_final = dffun_[['loan_amnt','int_rate','annual_inc','inq_last_6mths','open_acc','log_pub_rec','revol_bal',
                   'revol_util','tot_cur_bal','lc_fun_amt','delinq_2yrs','total_pay_f','acc_now_delinq','out_prncp_inv','month',
                   'emp_more_fiv','lc_fun','grade','sub_grade', 'home_ownership','verification_status','purpose','addr_state','over_five'
                   ]]
...
df_final_cat = dffun_[['grade','sub_grade','home_ownership','verification_status','purpose','addr_state']]


# Predicition

x = df_final[['loan_amnt','int_rate', 'annual_inc', 'inq_last_6mths','open_acc','log_pub_rec','revol_bal',
'revol_util','tot_cur_bal','lc_fun_amt','delinq_2yrs','total_pay_f','acc_now_delinq','out_prncp_inv','month','emp_more_fiv','lc_fun',
...
x= OneHotEncoder(handle_unknown = 'ignore').fit_transform(x.iloc[:,17:23])        
